...
<template>
    <FormSection @submitted="updateProfileInformation">
        ...
        <template #form>
                ...
                <div v-if="$page.props.jetstream.hasEmailVerification && user.email_verified_at === null">
                    <p class="text-sm mt-2">
                        ...
                        <Link
                            ...
                            method="post"
                            as="button"
                            class="underline text-sm text-stone-800 hover:text-red-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-600"
            ...
            <!-- Web site -->
            <div class="col-span-6 sm:col-span-4">
                <InputLabel for="web_site" value="Sitio web" />
                <TextInput
                    id="web_site"
